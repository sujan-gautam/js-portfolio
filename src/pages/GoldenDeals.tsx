            ...
            <div className="relative w-full aspect-video overflow-hidden bg-[#0a0a0a] flex items-center justify-center">
              <div className="text-center p-8">
                <div className="w-20 h-20 rounded-full bg-white/5 mx-auto flex items-center justify-center mb-6">
                  <ShoppingBag size={32} className="text-[#CB2729]" />
                </div>
                <h2 className="text-3xl font-bold tracking-tight mb-4 font-outfit">The Student Marketplace Feed</h2>
                <p className="text-white/50 max-w-md mx-auto">
                  A dynamic, personalized feed mixing organic student listings, targeted search results, and integrated native advertisements.
                </p>
              </div>
