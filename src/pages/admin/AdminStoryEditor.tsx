    ...
    >
      ...
      {isTrimmingMusic && item.musicVideoId && (
        <div className="fixed inset-0 z-[250] bg-black/60 backdrop-blur-sm animate-in fade-in duration-300 flex flex-col items-center justify-center">
          <div className="absolute left-0 right-0 px-6 sm:px-8 flex items-center justify-between z-10" style={{ top: 'max(3rem, env(safe-area-inset-top, 3rem))' }}>
          ...
          {/* Bottom Trimmer Bar */}
          <div className="absolute inset-x-0 px-4 sm:px-8 animate-in slide-in-from-bottom-8 duration-500" style={{ bottom: 'max(3rem, env(safe-area-inset-bottom, 3rem))' }}>
