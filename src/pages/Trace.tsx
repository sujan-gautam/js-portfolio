      ...
      <main className="relative z-10 pt-32 pb-24 md:pt-40 md:pb-32 px-6 md:px-12 max-w-7xl mx-auto space-y-32">
        ...
        <section className="animate-in fade-in slide-in-from-bottom-8 duration-700">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-[80px] font-black leading-[0.95] tracking-tight mb-8 font-outfit">
            Trace<br />
            <em className="not-italic text-transparent" style={{ WebkitTextStroke: '1.5px rgba(255,255,255,0.2)' }}>Time-Travel Debugger</em>
          </h1>
          <p className="text-white/55 text-[15px] md:text-[17px] max-w-[650px] leading-[1.75] font-normal tracking-[0.01em]">
          ...
          <div className="flex flex-wrap items-center gap-6 mt-10">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 border border-[#CB2729]/40 rounded text-[#CB2729] font-mono text-[11px] tracking-[0.05em]">
              <span className="w-1.5 h-1.5 rounded-full bg-[#CB2729] shadow-[0_0_6px_rgba(203,39,41,0.8)] animate-pulse"></span>
        ...
        <section id="solves" className="scroll-mt-24 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="bg-[#111] border border-white/10 p-8 rounded-xl hover:border-white/20 transition-colors">
              <Brain className="w-8 h-8 text-[#CB2729] mb-6" />
            ...
            <div className="bg-[#111] border border-white/10 p-8 rounded-xl hover:border-white/20 transition-colors">
              <BookOpen className="w-8 h-8 text-[#CB2729] mb-6" />
            ...
            <div className="bg-[#111] border border-white/10 p-8 rounded-xl hover:border-white/20 transition-colors">
              <CloudRain className="w-8 h-8 text-[#CB2729] mb-6" />
        ...
        <section id="features" className="scroll-mt-24 space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="group flex gap-6 p-6 md:p-8 bg-[#111] border border-white/5 rounded-2xl hover:border-white/20 transition-all duration-300">
              <div className="w-12 h-12 flex items-center justify-center rounded-full bg-white/5 text-white/80 group-hover:bg-[#CB2729]/10 group-hover:text-[#CB2729] transition-colors shrink-0">
            ...
            <table className="w-full text-left border-collapse min-w-[700px]">
              ...
              <tbody className="text-[14px]">
                <tr className="hover:bg-white/5 transition-colors border-b border-white/5">
                  ...
                  <td className="py-4 px-6 text-[#CB2729]">React (v18), Vite, TypeScript</td>
                ...
                <tr className="hover:bg-white/5 transition-colors border-b border-white/5">
                  ...
                  <td className="py-4 px-6 text-[#CB2729]">Vanilla CSS, Tailwind CSS</td>
                ...
                <tr className="hover:bg-white/5 transition-colors border-b border-white/5">
                  ...
                  <td className="py-4 px-6 text-[#CB2729]">@babel/standalone</td>
                ...
                <tr className="hover:bg-white/5 transition-colors border-b border-white/5">
                  ...
                  <td className="py-4 px-6 text-[#CB2729]">GSAP, Anime.js</td>
                ...
                <tr className="hover:bg-white/5 transition-colors border-b border-white/5">
                  ...
                  <td className="py-4 px-6 text-[#CB2729]">TanStack Query, React Router</td>
                ...
                <tr className="hover:bg-white/5 transition-colors border-b border-white/5">
                  ...
                  <td className="py-4 px-6 text-[#CB2729]">Node.js, Express, MongoDB</td>
                ...
                <tr className="hover:bg-white/5 transition-colors border-b border-white/5">
                  ...
                  <td className="py-4 px-6 text-[#CB2729]">Socket.io</td>
                ...
                <tr className="hover:bg-white/5 transition-colors border-b border-white/5">
                  ...
                  <td className="py-4 px-6 text-[#CB2729]">Gemini API, WebCodecs, TTS</td>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20">
              <div className="space-y-6">
                <div className="bg-[#111] border border-white/5 p-6 rounded-xl relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-bold font-outfit mb-4 text-[#CB2729]">1. AST Instrumentation</h3>
                  <p className="text-white/60 text-sm leading-relaxed mb-4">
                    The compiler utilizes <code className="text-[#CB2729] bg-[#CB2729]/10 px-1.5 py-0.5 rounded text-xs">@babel/standalone</code> to analyze and instrument code before execution:
                  </p>
                  <ul className="text-sm text-white/50 space-y-3 list-disc pl-4 marker:text-[#CB2729]">
  ...
  return state;
              ...
              <div className="space-y-6">
                <div className="bg-[#111] border border-white/5 p-6 rounded-xl relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-bold font-outfit mb-4 text-[#CB2729]">2. High-Fidelity Rendering</h3>
                  <p className="text-white/60 text-sm leading-relaxed mb-4">
                ...
                <div className="bg-[#111] border border-white/5 p-6 rounded-xl relative overflow-hidden">
                  ...
                  <h3 className="text-xl font-bold font-outfit mb-4 text-[#CB2729]">3. Serverless Resilience</h3>
                  <ul className="text-sm text-white/50 space-y-3 list-disc pl-4 marker:text-[#CB2729]">
        ...
        <section className="space-y-8">
          ...
          <div className="bg-[#0a0a0a] border border-white/10 rounded-xl p-6 md:p-8 font-mono text-sm overflow-x-auto">
            <div className="flex flex-col gap-1 text-white/60 min-w-max">
              <div className="text-[#CB2729] font-bold">time-rewind-dev/</div>
              ...
              <div className="flex items-center gap-2 pl-4"><span className="text-white/30">├──</span> <span className="text-white">src/</span> <span className="text-[#CB2729] ml-4 hidden md:inline"># React Frontend App</span></div>
